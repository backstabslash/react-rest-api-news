...
class News extends Component {
    ...
    handlePageChange = ({ target }) => {
        const btnType = target.dataset.name;
        let { page } = this.state;
        switch (btnType) {
            case 'next':
    ...
    updatePage = (newpage) => {
        ...
        this.setState({ page: newpage }, () => {
            this.fetchData(searchQuery, hitsPerPage, newpage);
        })
    };
    ...
    render() {
        ...
        return (
            <div className="wrapper">
                ...
                <Input onKeyDown={this.getSearch} onChange={this.handleInputChange}
                    value={searchQuery} onClick={this.getSearchIcon} />
